...
Object.defineProperty(URL.prototype, '_id', {get: function(){
  ...
  return this.data.servers[0].host.toLowerCase() + ':' + this.data.servers[0].port;
}});

Object.defineProperty(URL.prototype, 'hp', {get: function(){
  return this.data.servers[0].host.toLowerCase() + ':' + this.data.servers[0].port;
}});
