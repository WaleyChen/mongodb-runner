...
module.exports = function(app){
  app.get('/api/v1/:instance_id/:database_name', stats, names, function(req, res){
    res.send({
      name: req.db.name,
  ...
  app.get('/api/v1/:instance_id/:database_name/profiling', function(req, res, next){
  ...
  app.get('/api/v1/:instance_id/:database_name/profiling/entries', function(req, res, next){
